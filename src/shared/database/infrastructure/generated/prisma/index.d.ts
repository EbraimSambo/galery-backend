...
export namespace Prisma {
  ...
  */
  ...
  export type GalleryCountOutputTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    iamges?: boolean | GalleryCountOutputTypeCountIamgesArgs
  }
   ...
   * GalleryCountOutputType without action
   */
  export type GalleryCountOutputTypeCountIamgesArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
  ...
  export type GallerySelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    updatedAt?: boolean
    deletedAt?: boolean
    iamges?: boolean | Gallery$iamgesArgs<ExtArgs>
  ...
  export type GalleryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"internalId" | "id" | "name" | "createdAt" | "updatedAt" | "deletedAt", ExtArgs["result"]["gallery"]>
  ...
  export type $GalleryPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    name: "Gallery"
    objects: {
      iamges: Prisma.$ImagePayload<ExtArgs>[]
    }
  ...
  export interface GalleryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const galleryWithInternalIdOnly = await prisma.gallery.findMany({ select: { internalId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Galleries and only return the `internalId`
     * const galleryWithInternalIdOnly = await prisma.gallery.createManyAndReturn({
     ...
     * })
     * 
     * // Update zero or more Galleries and only return the `internalId`
     * const galleryWithInternalIdOnly = await prisma.gallery.updateManyAndReturn({
     *   select: { internalId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  export interface Prisma__GalleryClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    iamges<T extends Gallery$iamgesArgs<ExtArgs> = {}>(args?: Subset<T, Gallery$iamgesArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ImagePayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
  ...
  interface GalleryFieldRefs {
    readonly internalId: FieldRef<"Gallery", 'Int'>
   ...
   * Gallery.iamges
   */
  export type Gallery$iamgesArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type ImageOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"internalId" | "id" | "name" | "path" | "published" | "galleryInternalId" | "createdAt" | "updatedAt" | "deletedAt", ExtArgs["result"]["image"]>
  ...
  export interface ImageDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `internalId`
     * const imageWithInternalIdOnly = await prisma.image.findMany({ select: { internalId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Images and only return the `internalId`
     * const imageWithInternalIdOnly = await prisma.image.createManyAndReturn({
     *   select: { internalId: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Images and only return the `internalId`
     * const imageWithInternalIdOnly = await prisma.image.updateManyAndReturn({
     *   select: { internalId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface ImageFieldRefs {
    readonly internalId: FieldRef<"Image", 'Int'>
    readonly id: FieldRef<"Image", 'String'>
    readonly name: FieldRef<"Image", 'String'>
    readonly path: FieldRef<"Image", 'String'>
    readonly published: FieldRef<"Image", 'Boolean'>
    readonly galleryInternalId: FieldRef<"Image", 'Int'>
  ...
  export type GalleryWhereInput = {
    ...
    internalId?: IntFilter<"Gallery"> | number
    ...
    iamges?: ImageListRelationFilter
  }
  ...
  export type GalleryOrderByWithRelationInput = {
    ...
    iamges?: ImageOrderByRelationAggregateInput
  }
  ...
  export type GalleryScalarWhereWithAggregatesInput = {
    ...
    internalId?: IntWithAggregatesFilter<"Gallery"> | number
  ...
  export type ImageWhereInput = {
    ...
    internalId?: IntFilter<"Image"> | number
    id?: StringFilter<"Image"> | string
    name?: StringFilter<"Image"> | string
    path?: StringFilter<"Image"> | string
    published?: BoolFilter<"Image"> | boolean
    galleryInternalId?: IntFilter<"Image"> | number
  ...
  export type ImageScalarWhereWithAggregatesInput = {
    ...
    internalId?: IntWithAggregatesFilter<"Image"> | number
    id?: StringWithAggregatesFilter<"Image"> | string
    name?: StringWithAggregatesFilter<"Image"> | string
    path?: StringWithAggregatesFilter<"Image"> | string
    published?: BoolWithAggregatesFilter<"Image"> | boolean
    galleryInternalId?: IntWithAggregatesFilter<"Image"> | number
  ...
  export type GalleryCreateInput = {
    ...
    iamges?: ImageCreateNestedManyWithoutGalleryInput
  }
  ...
  export type GalleryUncheckedCreateInput = {
    ...
    updatedAt?: Date | string
    deletedAt?: Date | string | null
    iamges?: ImageUncheckedCreateNestedManyWithoutGalleryInput
  }
  ...
  export type GalleryUpdateInput = {
    ...
    iamges?: ImageUpdateManyWithoutGalleryNestedInput
  }
  ...
  export type GalleryUncheckedUpdateInput = {
    ...
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    deletedAt?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    iamges?: ImageUncheckedUpdateManyWithoutGalleryNestedInput
  }
  ...
  export type ImageCreateInput = {
    ...
    updatedAt?: Date | string
    deletedAt?: Date | string | null
    gallery: GalleryCreateNestedOneWithoutIamgesInput
  }
  ...
  export type ImageUpdateInput = {
    ...
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    deletedAt?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    gallery?: GalleryUpdateOneRequiredWithoutIamgesNestedInput
  }
  ...
  export type ImageUncheckedUpdateInput = {
    ...
    path?: StringFieldUpdateOperationsInput | string
    published?: BoolFieldUpdateOperationsInput | boolean
    galleryInternalId?: IntFieldUpdateOperationsInput | number
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    deletedAt?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  }
  ...
  export type GalleryCreateNestedOneWithoutIamgesInput = {
    create?: XOR<GalleryCreateWithoutIamgesInput, GalleryUncheckedCreateWithoutIamgesInput>
    connectOrCreate?: GalleryCreateOrConnectWithoutIamgesInput
  ...
  export type GalleryUpdateOneRequiredWithoutIamgesNestedInput = {
    create?: XOR<GalleryCreateWithoutIamgesInput, GalleryUncheckedCreateWithoutIamgesInput>
    connectOrCreate?: GalleryCreateOrConnectWithoutIamgesInput
    upsert?: GalleryUpsertWithoutIamgesInput
    connect?: GalleryWhereUniqueInput
    update?: XOR<XOR<GalleryUpdateToOneWithWhereWithoutIamgesInput, GalleryUpdateWithoutIamgesInput>, GalleryUncheckedUpdateWithoutIamgesInput>
  }
  ...
  export type GalleryCreateWithoutIamgesInput = {
    id?: string
    name: string
    createdAt?: Date | string
    updatedAt?: Date | string
  ...
  export type GalleryUncheckedCreateWithoutIamgesInput = {
    internalId?: number
    id?: string
    name: string
    createdAt?: Date | string
  ...
  export type GalleryCreateOrConnectWithoutIamgesInput = {
    where: GalleryWhereUniqueInput
    create: XOR<GalleryCreateWithoutIamgesInput, GalleryUncheckedCreateWithoutIamgesInput>
  }

  export type GalleryUpsertWithoutIamgesInput = {
    update: XOR<GalleryUpdateWithoutIamgesInput, GalleryUncheckedUpdateWithoutIamgesInput>
    create: XOR<GalleryCreateWithoutIamgesInput, GalleryUncheckedCreateWithoutIamgesInput>
    where?: GalleryWhereInput
  }

  export type GalleryUpdateToOneWithWhereWithoutIamgesInput = {
    where?: GalleryWhereInput
    data: XOR<GalleryUpdateWithoutIamgesInput, GalleryUncheckedUpdateWithoutIamgesInput>
  }

  export type GalleryUpdateWithoutIamgesInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type GalleryUncheckedUpdateWithoutIamgesInput = {
    internalId?: IntFieldUpdateOperationsInput | number
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
